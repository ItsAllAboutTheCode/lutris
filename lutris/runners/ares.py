...
class ares(Runner):
    ...
    system_choices = (
        ...
        (_("Sega Mega Drive (Genesis)"), "Game Gear"),
        (_("Sega Game Gear"), "Mega Drive"),
        ...
        (_("Sinclair ZX Spectrum"), "ZX Spectrum 128"),
    )
    ...
    runner_options = [
        ...
        },
        {
            ...
            "help": _(
                ...
                "Availables Settings are in the $XDG_DATA_HOME/ares/settings.bml file"
            ),
            "advanced": True,
        },
        {
    ...
    def get_platform(self):
        emu_system = self.game_config.get("system")
        if emu_system:
