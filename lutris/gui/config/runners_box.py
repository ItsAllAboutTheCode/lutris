...
class RunnersBox(BaseConfigBox):
    ...
    def __init__(self):
        ...
        # Trampoline from the AddRunnerConfigBox.signal.show_crated singal
        # allow the RunnersBox widget to listen to CreateRunnerConfigDialog.signals.runner-created
        def on_show_create_runner_dialog(widget, create_dialog_window):
            create_dialog_window.connect("runner-saved", self.append_runners)
    ...
    def _on_runner_created(self, _widget, runner_name):
