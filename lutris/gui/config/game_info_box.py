...
class GameInfoBox(AdvancedSettingsBox):
    ...
    def _get_banner_box(self):
        ...
        self._create_image_button(banner_box, COVERART_KEY, _("Set custom cover art"), _("Remove custom cover art"))
        self._create_image_button(banner_box, BANNER_KEY, _("Set custom banner"), _("Remove custom banner"))
        self._create_image_button(banner_box, ICON_KEY, _("Set custom icon"), _("Remove custom icon"))
